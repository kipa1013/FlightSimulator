...
public partial class @PlaneInput : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""VrGrabYoke"",
                    ""type"": ""Button"",
                    ""id"": ""38c762a3-644a-4601-9083-2e00e4e8c3a3"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""a925fd90-bcdd-432e-b135-86a7349a5251"",
                ...
                {
                    ""name"": """",
                    ""id"": ""58f5f8b6-fc84-4b8e-9512-69690d26ea58"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_Plane_VrGrabYoke = m_Plane.FindAction("VrGrabYoke", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Plane_VrGrabYoke;
    public struct PlaneActions
    {
        ...
        public InputAction @VrGrabYoke => m_Wrapper.m_Plane_VrGrabYoke;
        ...
        public void SetCallbacks(IPlaneActions instance)
        {
            if (m_Wrapper.m_PlaneActionsCallbackInterface != null)
            {
                ...
                @VrGrabYoke.started -= m_Wrapper.m_PlaneActionsCallbackInterface.OnVrGrabYoke;
                @VrGrabYoke.performed -= m_Wrapper.m_PlaneActionsCallbackInterface.OnVrGrabYoke;
                @VrGrabYoke.canceled -= m_Wrapper.m_PlaneActionsCallbackInterface.OnVrGrabYoke;
            }
            ...
            if (instance != null)
            {
                ...
                @VrGrabYoke.started += instance.OnVrGrabYoke;
                @VrGrabYoke.performed += instance.OnVrGrabYoke;
                @VrGrabYoke.canceled += instance.OnVrGrabYoke;
            }
        }
    }
    ...
    public interface IPlaneActions
    {
        ...
        void OnVrGrabYoke(InputAction.CallbackContext context);
    }
}
